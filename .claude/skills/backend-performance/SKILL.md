...
description: Optimización de rendimiento en Laravel 12 para SENTINEL 3.0 — detección de N+1, eager loading, paginación, caché, índices de BD. Usar al crear/modificar controllers con queries, agregar relaciones a modelos, o hacer code review de performance.
---
