---
name: laravel-crud-workflow
description: Workflow paso a paso para crear un recurso CRUD completo en el backend SENTINEL 3.0 (migración, modelo, controller, rutas, evento broadcast). Usar al crear un nuevo recurso/submódulo o replicar el patrón CRUD existente para una tabla nueva.
---
