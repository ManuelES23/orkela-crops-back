...
description: Auditoría de seguridad para SENTINEL 3.0 (OWASP Top 10, validación, SQL injection, XSS, aislamiento multi-tenant) en Laravel + React. Usar al crear endpoints que reciben input, manejar uploads, autenticación/autorización, o al hacer code review de seguridad.
---
