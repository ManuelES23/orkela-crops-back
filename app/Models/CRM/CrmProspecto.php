...
class CrmProspecto extends Model
{
    ...
    {
        return $this->belongsTo(CrmBodega::class, 'bodega_id');
    }
    ...
    {
        return $this->hasMany(CrmCliente::class, 'prospecto_id');
    }

    public function scopeActivos($query)
    {
        return $query->whereNotIn('estatus', ['descartado']);
    }
    ...
    public function scopePorRegion($query, int $regionId)
    {
